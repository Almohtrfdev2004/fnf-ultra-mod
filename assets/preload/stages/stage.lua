...
makeLuaSprite('bartop','',0.5,-20)
	...
	makeLuaSprite('guitar-stage', 'stages/guitar-stage/guitar-stage', -400, -100);
	setScrollFactor('guitar-stage', 0.3, 0.3);
	scaleObject('guitar-stage', 1.2, 1)
	addLuaSprite('guitar-stage', false);
	setProperty('guitar-stage.visible', true);
