...
makeLuaSprite('bartop','',0.5,-20)
	...
	-- background shit
	makeLuaSprite('day', 'stages/k-1/day', -376, -100);
	...
	makeAnimatedLuaSprite('people1','stages/k-1/people-day',-92, 150)
...
setProperty('people1.visible', false);
	...
	makeLuaSprite('sun', 'stages/k-1/sunset', -376, -100);
...
setProperty('people2.visible', false);
	...
	makeLuaSprite('night', 'stages/k-1/night', -376, -100);
