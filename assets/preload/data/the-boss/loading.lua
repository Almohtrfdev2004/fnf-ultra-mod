...
local scale = 1
local ldim = 'loading/kilfor-no-b' --put here your image name (the image must have a size of 1675 x 1083)
local loading = false

function onCreate()

    makeLuaSprite('ld', 'loading/kilfor-no-b', 0, -0) -- creating the image
